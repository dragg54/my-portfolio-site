...
export const About = () => {
  ...
  return (
    <div data-aos="fade-up" data-aos-duration="2000" className='h-[700px] bg-gray-200 w-full px-10 pt-10 font-[Poppins] sm:h-[550px] md:px-14 md:py-14 lg:p-20 xl:p-36' id="about">
        ...
        <p className='text-[#323432] font-[poppins] text-sm sm:text-base'>A frontend developer whose interest revolves around developing 
        ...
        <p className='text-[#323432] font-[poppins] text-sm sm:text-base mt-6'>Oh yeah!! When I'm not building any project, 
        ...
        <button className='text-[10px] bg-[#E34234] px-4 py-3 text-green-100 shadow-2xl mt-8 font-[Poppins] sm:mt-9'>DOWNLOAD RESUME</button> 
