  ...
  return (
    <div className='w-full bg-gray-400  h-[1400px] px-10 py-6'>
      ...
      <div className='mt-12 relative font-[poppins]'><img src="../../../images/project.png" alt="" />
       ...
       <div className='w-full flex justify-center flex-col items-center'>  <h1 className='mt-32 text-2xl text-[#323432] font-extrabold font-[Roboto]'>E-Commerce Site</h1>
      ...
      <div className='mt-24 relative'><img src="../../../images/project2.png" alt="" />
       <div className='h-40 w-20 overflow-hidden absolute right-0 top-32 '><img src="../../../images/project2mobile.png" alt="" /></div>
       <div className='w-full flex justify-center flex-col items-center'>  <h1 className='mt-28 text-2xl text-[#323432] font-extrabold font-[Roboto]'>Interior Designer</h1>
