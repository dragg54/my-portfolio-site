...
export const About = () => {
  return (
    <div className=' h-[345px] bg-[#0B1F65] w-full px-6 pt-10 font-[righteous]'>
        <h1 className='text-4xl font-bold text-[#E34234] mb-4 flex w-[210px] justify-between'>About Me <FaMicroscope /></h1>
        <p className='text-white font-[poppins] text-sm'>A frontend developer whose interest revolves around developing 
