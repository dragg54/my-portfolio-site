...
const Projects = () => {
  return (
    <div className='w-full bg-[#54627B] h-[1470px] px-10 py-10 sm:h-[1400px] md:px-14 md:py-14 md:h-[1200px] xl:p-36 xl:h-[1500px]' id="projects">
      ...
      <p className='text-[#323432] font-[poppins]' data-aos="fade-up" data-aos-duration="1000">Using various technologies, I've built various projects, both large and minor. Below are some of the projects built by me</p>
      <div className='mt-12 relative font-[poppins] flex flex-col md:flex-row  items-center justify-between md:w-full'>
        <div className=' w-[305px] h-[200px] md:w-full md:h-full object-contain border-8 border-black shadow-[1px_1px_1px_1px_gray] md:mr-8 relative'>
          <div className='absolute w-full h-full bg-red-800 opacity-70  hover:opacity-0 transition duration-1000 z-10'></div>
        ...
        <div className='flex justify-center flex-col sm:w-4/5 items-center md:w-3/5'>
          <h1 className='mt-8 text-2xl text-[#323432] font-extrabold font-[Roboto]'>E-Commerce Site</h1>
          <p className='text-[#323432]' data-aos="fade-up" data-aos-duration="1000">Everyone loves shopping. So I built this multi-paged and responsive shopping site using React js, Javascript
      ...
      <div className=' w-[305px] h-[200px] md:w-full md:h-full object-contain border-8 border-black shadow-[1px_1px_1px_1px_gray] relative md:mr-8'>
        ...
        <div className='flex justify-center flex-col items-center sm:w-4/5 md:w-3/5'>  <h1 className='mt-8 text-2xl text-[#323432] font-extrabold font-[Roboto]'>Interior Designer</h1>
          <p className='text-[#323432] font-[Poppins]' data-aos="fade-up" data-aos-duration="1000">This project reflects my knowledge of good UI. It was developed using HTML, Javascript and Tailwind CSS</p>
          <h4 className='mt-4 font-[lobster] text-blue-500 mb-1'>Tools Used</h4>
          <div className='flex justify-center items-center h-7'>
