...
const Projects = () => {
  return (
    <div className='w-full bg-[#54627B] h-auto px-10 py-10 sm:h-auto md:px-14 md:py-14 md:h-auto xl:p-36 xl:h-auto' id="projects">
      ...
      <div className='mt-24 relative md:flex justify-between flex flex-col md:flex-row items-center'>
        <div className=' w-[305px] h-[200px] md:w-full md:h-full object-contain border-8 border-black shadow-[1px_1px_1px_1px_gray] relative md:mr-8'>
          <img src="/images/project3.png" alt="" className='md:w-full h-full w-full' /></div>
        <div className='h-40 w-20 overflow-hidden absolute right-0 top-32 '></div>
        <div className='flex justify-center flex-col items-center sm:w-4/5 md:w-3/5'>  <h1 className='mt-8 text-2xl text-[#E34234] font-extrabold font-[Roboto]'>Plankers</h1>
          <p className='text-gray-300 font-[Poppins]' data-aos="fade-up" data-aos-duration="1000">An ecommerce website for a furniture company. Built with React and NodeJs, it entails all the functionalities required for small-scale e-commerce operations</p>
          <h4 className='mt-4 font-[lobster] text-blue-500 mb-1'>Tools Used</h4>
          <div className='flex justify-center items-center h-7'>
            <img src="../../icons/react.png" alt="" className='h-5 w-5 mr-3' />
          ...
          <a href="http://myefurniturestore.netlify.app" target="_blank" rel="noreferrer"><button className='text-[10px] bg-[#E34234] px-4 py-3 text-green-100  mt-8 font-[Poppins] mx-auto shadow-[2xl_2xl_2xl_red] rounded-md'>VIEW PROJECT</button></a></div>
      </div>
      <div className='mt-12 relative font-[poppins] flex flex-col md:flex-row  items-center justify-between md:w-full'>
        ...
        <div className='flex justify-center flex-col sm:w-4/5 items-center md:w-3/5'>
          ...
          <p className='text-gray-300' data-aos="fade-up" data-aos-duration="1000">A multi-paged and responsive shopping site using React js, Javascript
            and Styled-Components.</p>
          <h4 className='mt-4 font-[lobster] text-blue-500 mb-1'>Tools Used</h4>
          <div className='flex justify-center items-center h-7'>
            <img src="../../icons/NEXT.png" alt="" className='h-5 w-5 mr-3' />
            <img src="../../icons/react.png" alt="" className='h-5 w-7 mr-3' />
