...
export const Hero  = () => {
  return (
    <div className="h-[460px] w-full bg-[#0C1446] px-6 pt-6">
        ...
        <p className='text-sm text-[#E34234] font-[Poppins]'>Frontend Developer.</p>
        ...
        <button className='text-[10px] border border-[#E34234] px-4 py-3 text-[#E34234] mt-10'>DOWNLOAD RESUME</button>
        <MediaIcons />
    </div>
  )
}
